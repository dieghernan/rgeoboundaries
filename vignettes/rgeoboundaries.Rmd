---
title: "rgeoboundaries: A Client for the geoBoundaries Administrative Boundaries Dataset"
bibliography: REFERENCES.bib
link-citations: yes
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{rgeoboundaries: A Client for the geoBoundaries Administrative Boundaries Dataset}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

<!-- rgeoboundaries.Rmd is generated from rgeoboundaries.Rmd.orig. Please edit that file -->
...
downloading and working with global political and administrative boundary data
from the [geoBoundaries](https://www.geoboundaries.org/) project
[@geoboundaries].

These datasets are openly licensed ([CC BY
4.0](https://creativecommons.org/licenses/by/4.0/)) and cover countries
worldwide across multiple administrative levels. With **rgeoboundaries**, you
can easily fetch boundary geometries as **sf** objects, explore metadata, cache
...
`gb_get_world()`. This function downloads global composite datasets for
...
Specific cache directories on each function call can be set using the `path`
...
The **rgeoboundaries** package makes it easy to fetch, manage and visualize
