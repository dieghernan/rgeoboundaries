...
join with other data), this package simplifies the process.
...
With respect to works on or made available through download from this website,
...
be liable for any costs, expenses, claims, or demands arising out of use of such
works.
