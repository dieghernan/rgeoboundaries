...
ggplot(sea_poly) +
  geom_sf(fill = "#bee0ff") +
  geom_sf(data = world, fill = "#f0b323", color = "white", 
  linewidth = 0.1) +
...
boundary data being accessed (via geoBoundaries) also uses open licences;
please check the specific dataset metadata for licensing details.
