...
API](https://www.geoboundaries.org/), providing country political administrative
boundaries.
...
This is a basic example which shows you how get Mali and Senegal boundaries and
plot it
...
In order to access the global administrative zones, you just need to skip the
country argument (i.e set it to `NULL`) or specify `type = "CGAZ"`.
...
> Runfola D, Anderson A, Baier H, Crittenden M, Dowker E, Fuhrig S, et al.
