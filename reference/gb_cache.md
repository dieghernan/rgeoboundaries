...
newcache
#> [1] "C:\\Users\\RUNNER~1\\AppData\\Local\\Temp\\RtmpyUKWLe/example/cache"
...
#> ✔ File C:\Users\RUNNER~1\AppData\Local\Temp\RtmpyUKWLe/example/cache/a.txt deleted.
gb_list_cache()
#> [1] "b.txt" "c.txt"

# Delete all cached files
gb_clear_cache(quiet = FALSE)
#> ! rgeoboundaries cache data deleted: C:\Users\RUNNER~1\AppData\Local\Temp\RtmpyUKWLe/example/cache
gb_list_cache()
#> character(0)

# Restore the initial cache
gb_set_cache(my_cache)
#> ✔ rgeoboundaries cache directory set to C:\Users\RUNNER~1\AppData\Local\Temp\RtmpyUKWLe/rgeoboundaries.
