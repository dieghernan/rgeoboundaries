...
newcache
#> [1] "/tmp/RtmpFCx1Dm/example/cache"
...
#> ✔ File /tmp/RtmpFCx1Dm/example/cache/a.txt deleted.
...
#> ! rgeoboundaries data deleted: /tmp/RtmpFCx1Dm/example/cache
...
#> ✔ rgeoboundaries cache directory is /tmp/RtmpFCx1Dm/rgeoboundaries.
