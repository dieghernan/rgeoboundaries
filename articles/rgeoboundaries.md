...
current
#> [1] "C:\\Users\\diego\\AppData\\Local\\Temp\\RtmpuEQr6Y"

# Change to new
newdir <- file.path(tempdir(), "geobound_vignette")
gb_set_cache(newdir)
#> ✔ rgeoboundaries cache directory set to 'C:\Users\diego\AppData\Local\Temp\RtmpuEQr6Y/geobound_vignette'.
...
#> → Cache dir is 'C:\Users\diego\AppData\Local\Temp\RtmpuEQr6Y/geobound_vignette/gbOpen'
...
#> ✔ rgeoboundaries cache directory set to 'C:\Users\diego\AppData\Local\Temp\RtmpuEQr6Y'.
#> ℹ To reuse this `path` in future sessions, run this function with `install = TRUE`.
