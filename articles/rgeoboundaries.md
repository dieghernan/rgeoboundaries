...
current
#> [1] "C:\\Users\\RUNNER~1\\AppData\\Local\\Temp\\RtmpIDJKRE"

# Change to new
newdir <- file.path(tempdir(), "geobound_vignette")
gb_set_cache(newdir)
#> ✔ rgeoboundaries cache directory is 'C:\Users\RUNNER~1\AppData\Local\Temp\RtmpIDJKRE/geobound_vignette'.
...
#> → Cache dir is 'C:\Users\RUNNER~1\AppData\Local\Temp\RtmpIDJKRE/geobound_vignette/gbOpen'
...
#> ✔ rgeoboundaries cache directory is 'C:\Users\RUNNER~1\AppData\Local\Temp\RtmpIDJKRE'.
#> ℹ To install your `path` for use in future sessions run this function with `install = TRUE`.
