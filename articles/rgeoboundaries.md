...
current
#> [1] "C:\\Users\\diego\\AppData\\Local\\Temp\\RtmpWIKjPX"

# Change to new
newdir <- file.path(tempdir(), "/geoboundvignette")
gb_set_cache(newdir)
#> ✔ rgeoboundaries cache directory is 'C:\Users\diego\AppData\Local\Temp\RtmpWIKjPX//geoboundvignette'.
...
#> → Cache dir is 'C:\Users\diego\AppData\Local\Temp\RtmpWIKjPX//geoboundvignette/gbOpen'
...
#> ✔ rgeoboundaries cache directory is 'C:\Users\diego\AppData\Local\Temp\RtmpWIKjPX'.
#> ℹ To install your `path` for use in future sessions run this function with `install = TRUE`.
...
#> $ boundaryName         <chr> "Aruba", "Anguilla", "Argentina", "Antigua and Barbuda", "Bonaire Sin…
#> $ Continent            <chr> "Latin America and the Caribbean", "Latin America and the Caribbean",…
#> $ worldBankIncomeGroup <chr> "High-income Countries", "No income group available", "High-income Co…
