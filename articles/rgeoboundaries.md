...
gb_set_cache(newdir)
#> ✔ rgeoboundaries cache directory is '/tmp/RtmpFK4kAY//geoboundvignette'.
...
#> → Cache dir is '/tmp/RtmpFK4kAY//geoboundvignette/gbOpen'
...
#> ✔ rgeoboundaries cache directory is '/tmp/RtmpFK4kAY'.
#> ℹ To install your `path` for use in future sessions run this function with `install = TRUE`.
