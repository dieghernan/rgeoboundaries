...
current
#> [1] "C:\\Users\\diego\\AppData\\Local\\Temp\\Rtmpm0dwKO"

# Change to new
newdir <- file.path(tempdir(), "/geoboundvignette")
gb_set_cache(newdir)
#> ✔ rgeoboundaries cache directory is 'C:\Users\diego\AppData\Local\Temp\Rtmpm0dwKO//geoboundvignette'.
...
#> → Cache dir is 'C:\Users\diego\AppData\Local\Temp\Rtmpm0dwKO//geoboundvignette/gbOpen'
...
#> ✔ rgeoboundaries cache directory is 'C:\Users\diego\AppData\Local\Temp\Rtmpm0dwKO'.
#> ℹ To install your `path` for use in future sessions run this function with `install = TRUE`.
